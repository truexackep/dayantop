export const Expense = (props) => {
  return <svg {...props} width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" >
      ...
      <g id="Iconly/Light/Swap" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
          <g id="Swap" transform="translate(2.000000, 3.000000)" stroke="#000000" stroke-width="1.5">
